...
TreePair::TreePair(string &line_tree_src,string &line_tree_tgt,string &line_align)
{
...
/**************************************************************************************
 ...
 4. 算法简介: 见注释
************************************************************************************* */
void TreePair::build_tree_from_str(const string &line_tree,SyntaxNode* &root,vector<string> &words)
{
	...
	for(size_t i=0;i<toks.size();i++)
	{
		...
		else
		{
			...
			if(toks[i+1]==")")
			{
				cur_node->span = make_pair(word_idx,0);
...
************************************************************************************* */
void TreePair::cal_span_for_each_node(SyntaxNode* node,vector<vector<bool> > &span_to_node_flag)
{
...
/**************************************************************************************
 ...
 4. 算法简介: 见注释
************************************************************************************* */
Span TreePair::merge_span(Span span1,Span span2)
{
	if (span2.first == -1)
		return span1;
	if (span1.first == -1)
...
************************************************************************************* */
void TreePair::check_alignment_agreement()
{
	for (int beg=0;beg<src_sen_len;beg++)
	{
